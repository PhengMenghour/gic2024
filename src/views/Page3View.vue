<template>
    <div class="container">
        <div class="sidebar">
            <h1>Menu</h1>
            <ul>
                <li><router-link active-class="active" to="/page3/section1">Section 1</router-link></li>
                <li><router-link active-class="active" to="/page3/section2">Section 2</router-link></li>
                <li><router-link active-class="active" to="/page3/section3">Section 3</router-link></li>
                <li><router-link active-class="active" to="/page3/section4">Section 4</router-link></li>
            </ul>
        </div>
        <div class="content">
